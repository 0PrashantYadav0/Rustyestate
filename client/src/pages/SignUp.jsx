    ...
    <div className='p-3 max-w-lg mx-auto'>
      ...
      <div>
        <form className='flex flex-col gap-4' onSubmit={handleSubmit}>
          ...
          <button disabled={loading} className='uppercase bg-slate-700 p-3 text-white rounded-lg hover:bg-slate-800 disabled:opacity-80'>{loading?"Loading...":"Sign Up"}</button>
          <OAuth/>
        </form>
